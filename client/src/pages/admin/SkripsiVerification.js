        ...
        <div className="table-box">
          ...
          >
            <thead>
              <tr>
                <th scope="col">No</th>
                <th scope="col" className="td-lg">
                  Judul
                </th>
                <th scope="col" className="td-md">
                  Penulis
                </th>
                <th scope="col" className="td-sm">
                  Tahun
                </th>
                <th scope="col" className="td-lg">
                  Abstrak
                ...
                skripsi.map((item, i) => (
                  <tr key={i}>
                    ...
                    <td>
                      {!item.file_url ? (
                        ...
                        <a
                          ...
                          href={
                            "https://repo-skripsi.herokuapp.com/" +
                            item.file_url
                          }
                          target="_blank"
                          rel="noreferrer noopener"
                        >
                          <FaFilePdf className="icons" /> Klik
                        </a>
                      )}
                    </td>
                    <td>
                      {item.is_approved === 1 ? (
                        <div style={{ color: "#379683" }}>
                          <FaCheck /> Dipublikasikan
                        </div>
                      ) : item.is_approved === 0 ? (
                    ...
                    <td>
                      ...
                      {item.uploaded_at.split("T")[1].split(".000Z")}
                    </td>
                    <td>
                      {item.is_approved === 2 ? (
                        <></>
                        ...
                        <>
                          {item.processed_at.split("T")[0]}{" "}
                          {item.processed_at.split("T")[1].split(".000Z")}
                        </>
                      )}
                    </td>
                    <td>
                      <button
                        onClick={() => this.unapproved(item.id)}
                        className={
                          item.is_approved === 0
                            ? "btn-table"
                            : "btn-table btn-danger"
                        }
                        disabled={item.is_approved === 0 ? true : false}
                      >
                        Tolak
                      </button>
                      <button
                        onClick={() => this.approved(item.id)}
                        className={
                          item.is_approved === 1
                            ? "btn-table"
                            : "btn-table btn-handle"
                        }
                        disabled={item.is_approved === 1 ? true : false}
                      >
                        Publikasikan
                      </button>
                    </td>
