      ...
      <div className="main-box">
                ...
                users.map((user, i) => (
                  <tr key={i}>
                    ...
                    <td>
                      {!user.ktm_url ? (
                        ...
                        <img
                          ...
                          alt="ktm"
                          // src={"http://localhost:5000/" + user.ktm_url}
                          src={
                            "https://repo-skripsi.herokuapp.com/" + user.ktm_url
                          }
                        />
                      )}
                    </td>
                    <td>
                      ...
                      {user.created_at.split("T")[1].split(".000Z")}
                    </td>
                    <td>
                      {user.is_active === 0 ? (
                        <>-</>
                        ...
                        <>
                          {user.processed_at.split("T")[0]}{" "}
                          {user.processed_at.split("T")[1].split(".000Z")}
                        </>
                      )}
                    </td>
                    <td>
                    ...
                    <td>
                      <button
                        onClick={() => this.verified(user.id)}
                        className={
                          user.is_active === 1
                            ? "btn-table"
                            : "btn-table btn-handle"
                        }
                        disabled={user.is_active === 1 ? true : false}
                      >
                        Verifikasi
                      </button>
                      <button
        ...
        <Modal show={this.state.showModal} onHide={this.handleClose} centered>
          <Modal.Body className="admin-modal">
            ...
            <button
              onClick={() => this.unverified(this.state.id)}
